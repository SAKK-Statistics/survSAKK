...
The `survSAKK` R package provides the `surv.plot()` function, facilitating Kaplan-Meier survival analysis. Designed with user-friendliness and efficiency in mind. The package offers a robust tool for analysing survival data utilizing the functionalites of `survival::survfit()`.
