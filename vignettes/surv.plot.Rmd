...
surv.plot(veteran_trt_fit_yr,
          ...
          risktable.axislab.pos = 3)
```

## Custamisation of the risk table marging area

```{r risktable3}
surv.plot(veteran_fit_yr,
          # How many bottom lines should be drawn
          risktable.margin.bottom = 10,
          # How many left lines should be drawn
          risktable.margin.left = 8)
...
```{r plots2, fig.height = 12, fig.width = 7}
par(mfrow=c(2,1))
# Plot 1
